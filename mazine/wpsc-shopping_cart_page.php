  ...
  <?php if(wpsc_uses_shipping()): ?>
   ...
   <?php if(wpsc_uses_shipping()) : ?>
      ...
      <table class="productcart">
         ...
         <?php if (!wpsc_have_shipping_quote()) : // No valid shipping quotes ?>
               ...
               <?php _e('No valid shipping quotes', 'mazine'); ?>
   ...
   <?php do_action('wpsc_before_form_of_shopping_cart'); ?>
	...
	<div class="checkout_actions">
		<a class="button checkout-2" onclick="checkout_step(2, '#checkout_cont');"><span><span><?php _e('proceed', 'mazine') ?></span></span></a>
	</div>
</div>
</div>
<div id="step-2">
...
<div class="checkout_actions">
		<a class="button checkout-1" onclick="checkout_step(1, '#checkout_cont');"><span><span>go back</span></span></a>
	</div>
